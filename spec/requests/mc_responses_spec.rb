...
RSpec.describe "McResponses", type: :request do
  ...
  describe "positive tests" do 
    ...
    let!(:mc_option1) {McOption.create(option: "op1", id: 1, mc_question_id: 1)}
    let!(:mc_option2) {McOption.create(option: "op2", id: 2, mc_question_id: 1)}
